...
class GatoEncerradoModel {
	...
	def inicializarLaberintos(){
		val laberinto1 = new Laberinto("Casa embrujada" ,administrador)
		val laberinto2 = new Laberinto("Museo en la noche" ,administrador)
		val laberinto3 = new Laberinto("Pueblo Fantasma" ,administrador)
		val laberinto4 = new Laberinto("Escape del Cementerio" ,administrador)
